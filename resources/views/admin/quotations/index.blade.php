<x-admin-layout>
    ...
    <div class="mb-6 overflow-x-auto">
        <div class="flex gap-6 min-w-max md:min-w-0">
            ...
            <a href="{{ route('admin.quotations.index', ['status' => 'draft']) }}" class="flex-1 min-w-[200px] block hover:opacity-80 transition">
            <x-card class="h-full">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <a href="{{ route('admin.quotations.index', ['status' => 'sent']) }}" class="flex-1 min-w-[200px] block hover:opacity-80 transition">
            <x-card class="h-full">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <a href="{{ route('admin.quotations.approved') }}" class="flex-1 min-w-[200px] block hover:opacity-80 transition">
            <x-card class="h-full">
                <div class="flex items-center justify-between">
                    <div>
            ...
            <a href="{{ route('admin.quotations.cancelled') }}" class="flex-1 min-w-[200px] block hover:opacity-80 transition">
            <x-card class="h-full">
                <div class="flex items-center justify-between">
                    <div>
                        <p class="text-sm font-medium text-slate-600">Cancelled</p>
                        <p class="text-3xl font-bold text-orange-600 mt-1">{{ $stats['cancelled'] }}</p>
                    </div>
