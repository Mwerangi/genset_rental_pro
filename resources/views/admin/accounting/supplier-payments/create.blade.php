    ...
    <form method="POST" action="{{ route('admin.accounting.supplier-payments.store') }}" class="max-w-2xl space-y-5">
        ...
        <div class="bg-white border border-gray-200 rounded-xl shadow-sm p-5 space-y-4">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Amount (Tsh) <span class="text-red-500">*</span></label>
                    <input type="number" name="amount" id="amountInput" value="{{ old('amount') }}" step="0.01" min="0.01" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500" required>
            ...
            <div class="pt-1 text-xs text-gray-500 bg-blue-50 border border-blue-100 rounded-lg px-3 py-2">
                A journal entry will be automatically posted: <strong>DR Accounts Payable → CR Bank Account</strong>
            </div>
        </div>
