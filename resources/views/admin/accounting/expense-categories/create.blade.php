<x-admin-layout>
    <div class="mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-900 mt-2">New Expense Category</h1>
    </div>

    <div class="max-w-lg bg-white border border-gray-200 rounded-xl shadow-sm p-6">
        <form method="POST" action="{{ route('admin.accounting.expense-categories.store') }}">
            @csrf
            <div class="space-y-4">
                <div>
            ...
            <div class="flex justify-end gap-3 mt-6">
                ...
                <button type="submit" class="px-4 py-2 bg-red-600 text-white rounded-lg text-sm font-medium hover:bg-red-700">Create Category</button>
            </div>
        </form>
    </div>
</x-admin-layout>
