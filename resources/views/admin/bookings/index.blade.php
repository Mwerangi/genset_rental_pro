<x-admin-layout>
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-slate-600 mt-1">All active rental bookings</p>
        </div>
        <div class="flex items-center gap-3">
            <a href="{{ route('admin.bookings.cancelled') }}" class="inline-flex items-center gap-2 px-4 py-2.5 border border-slate-300 text-slate-600 rounded-lg hover:bg-slate-50 transition font-medium text-sm">
